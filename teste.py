    ...
    def game(score):  # Método principal da classe Menu que elabora todo o projeto
        while True:                                                                    # está funcionando
            ...
            if opc == 4:  # CONFIG                                  # está funcionando bem
                ...
                if opc == 1:  # RESENTANDO SCORE                        # resetar pontos está funcionando bem
                ...
                if opc == 2:  # ALTERANDO NOMES                     # deveria antes de mostrar alterar os nomes, mostrar os 
                    print("*** ALTERAÇÃO DOS NOMES ***\n")          # nomes de antes dos jogadores
                    print('Os Nomes são: nome 1°',score[0][0],'- nome 2°', score[1][0])             # fiz isso nessa linha
                    score[0][0] = Name(1)
                    score[1][0] = Name(2)
                ...
                if opc == 3:  # RESET                           # o  reset tá funcionando direito 
            ...
            if opc == 5:  # SAIR                    # a saida está funcionando direito
                print("*** FECHANDO ***\n")
